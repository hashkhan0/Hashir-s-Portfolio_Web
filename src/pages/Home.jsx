      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-white px-4 py-8">
        <div className="max-w-3xl text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl mb-6 sm:mb-10 max-w-2xl mx-auto">
            ...
            Actively pursuing a career in software development, with hands-on experience in developing web-applications with blockchain and smart contract integration.
          </p>
          ...
          <div className="flex justify-center space-x-6 mt-8 sm:mt-12">
            <a href="https://github.com/hashkhan0" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
            ...
            <a href="https://linkedin.com/in/hashkhan0" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
              <svg className="h-5 w-5 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 24 24">
