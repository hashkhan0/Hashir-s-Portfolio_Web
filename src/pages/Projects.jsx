...
const Projects = () => {
  ...
  const projects = [
    {
      id: 1,
      title: "Token Forge: ERC-20 Custom Token Generator",
      description: "Token Forge is a decentralized application (dApp) that allows users to easily create custom ERC-20 tokens on the Ethereum blockchain.",
      technologies: ["React", "Solidity", "Ether.js", "Metamask", "Express"],
      image: tokenForgeImage,
      link: "https://github.com/hashkhan0/Token-Forge",
      demo: "https://token-forge.netlify.app"
    },
    {
      id: 2,
      title: "Rare Finds",
      ...
      link: "https://github.com/hashkhan0/rarefinds",
    ...
    <div className="flex flex-col h-screen bg-gray-900 text-white overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 flex flex-col h-full">
        ...
        <div className="text-center mt-6">
          ...
          <a 
            href="https://github.com/hashkhan0"
            target="_blank"
            rel="noopener noreferrer"
