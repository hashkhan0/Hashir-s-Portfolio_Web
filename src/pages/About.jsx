        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white bg-opacity-10 rounded-lg shadow-xl p-6 md:p-8 mb-8 border border-gray-700">
            ...
            <p className="text-base sm:text-lg mb-6 text-white">
              I'm Hashir Khan, a passionate software engineer with strong problem-solving and analytical reasoning skills.
              Actively pursuing a career in blockchain development, with hands-on experience in Solidity and smart contract projects.
              Continuously enhancing problem-solving abilities through consistent practice on competitive programming platforms like
              LeetCode. Eager to contribute innovative and optimized solutions and want to grow in the rapidly evolving blockchain
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="mt-2 text-gray-300 text-white">
                    Relevant Coursework: Data Structures, Algorithms, Blockchain Development, Database Systems, Object Oriented programming.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <span className="px-3 py-1 bg-gray-700 rounded-full border border-gray-600">Solidity</span>
                  </div>
                </div>
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <span className="px-3 py-1 bg-gray-700 rounded-full border border-gray-600">Hardhat</span>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <span className="px-3 py-1 bg-gray-700 rounded-full border border-gray-600">MetaMask Dev</span>
